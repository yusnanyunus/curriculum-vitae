...
return (
<div id="herosection" className="relative min-h-screen">
{/* Background 3D */}
...
/>
 ...
 {/* Overlay semi-transparan untuk membuat teks lebih mudah dibaca */}
 ...
 <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 flex items-center justify-center min-h-screen">
  ...
  <div className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col w-11/12 md:w-3/4 lg:w-2/4">
